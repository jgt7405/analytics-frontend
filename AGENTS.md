...
**JThom Analytics** (www.jthomanalytics.com): college basketball and football projections, standings, schedules and tournament odds. Next.js 14 App Router frontend on Vercel. All data comes from a separate Flask backend on Railway, reached through this app's `/api/proxy` route.
