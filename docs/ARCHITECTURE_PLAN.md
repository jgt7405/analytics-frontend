...
Status: **steps 1, 2, 3 and 5 complete** (2026-09-26; step 5 was done ahead of 3–4 for security). **Step 4 in progress:** 4a (endpoint list, #23), 4b (proxy reads the list, #24) and 4c (contract tests) done; next 4d (component fetches into hooks). Baselines are in `docs/baselines/README.md`.
