...
Status: **steps 1, 2, 3 and 5 complete** (2026-09-26; step 5 was done ahead of 3–4 for security). **Step 4 in progress:** items 1–6 and 8 complete (4a–4h); next item 7 (fixtures). Baselines are in `docs/baselines/README.md`.
