// src/app/football/[season]/twv/page.tsx
"use client";
...
interface FootballTWVArchivePageProps {
  params: {
    season: string;
  };
}

export default function FootballTWVArchivePage({
  params,
}: FootballTWVArchivePageProps) {
  ...
  const {
    ...
    error: twvError,
    refetch,
  } = useFootballTWV(selectedConference, season);
  ...
  }, [twvError, selectedConference, season, trackEvent]);
