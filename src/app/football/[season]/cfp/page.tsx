// src/app/football/[season]/cfp/page.tsx
"use client";
...
interface FootballCFPArchivePageProps {
  params: {
    season: string;
  };
}

export default function FootballCFPArchivePage({
  params,
}: FootballCFPArchivePageProps) {
  ...
  const {
    ...
    error: cfpError,
    refetch,
  } = useFootballCFP(selectedConference, season);
