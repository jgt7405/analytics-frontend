// src/app/football/[season]/cwv/page.tsx
"use client";
...
interface FootballCWVArchivePageProps {
  params: {
    season: string;
  };
}

export default function FootballCWVArchivePage({
  params,
}: FootballCWVArchivePageProps) {
  ...
  const {
    ...
    error: cwvError,
    refetch,
  } = useFootballCWV(selectedConference, season);
