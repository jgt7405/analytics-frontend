// src/app/football/[season]/teams/page.tsx
"use client";
...
interface FootballTeamsArchivePageProps {
  params: {
    season: string;
  };
}
...
export default function FootballTeamsArchivePage({
  params,
}: FootballTeamsArchivePageProps) {
