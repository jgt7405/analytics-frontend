// src/app/football/[season]/conf_champ/page.tsx
"use client";
...
interface FootballConfChampArchivePageProps {
  params: {
    season: string;
  };
}

export default function FootballConfChampArchivePage({
  params,
}: FootballConfChampArchivePageProps) {
  ...
  const filteredHistoryData = useMemo(() => {
    ...
    return {
      ...historyData,
      champ_game_data: historyData.champ_game_data?.filter(item => {
        const itemDate = new Date(item.date);
        return itemDate >= seasonStart && itemDate <= seasonEnd;
      }) || [],
      champion_data: historyData.champion_data?.filter(item => {
        const itemDate = new Date(item.date);
        return itemDate >= seasonStart && itemDate <= seasonEnd;
      }) || [],
    };
  ...
  }, [confChampError, selectedConference, season, trackEvent]);
                    ...
                    <div className="mb-8">
                      ...
                      <div className="champ-game-chart">
                        <FootballChampGameHistoryChart
                          champGameData={filteredHistoryData.champ_game_data}
                        />
                      </div>
                    ...
                    <div className="mb-8">
                      ...
                      <div className="champion-chart">
                        <FootballConfChampionHistoryChart
                          championData={filteredHistoryData.champion_data}
                        />
                      </div>
