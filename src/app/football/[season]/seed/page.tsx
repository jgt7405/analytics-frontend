// src/app/football/[season]/seed/page.tsx
"use client";
...
interface FootballSeedArchivePageProps {
  params: {
    season: string;
  };
}

export default function FootballSeedArchivePage({
  params,
}: FootballSeedArchivePageProps) {
  ...
  const {
    ...
    error: seedError,
    refetch,
  } = useFootballSeed(selectedConference, season);
