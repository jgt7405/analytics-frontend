// src/app/basketball/[season]/schedule/page.tsx
"use client";
...
interface ArchiveSchedulePageProps {
  params: {
    season: string;
  };
}
...
export default function ArchiveSchedulePage({
  ...
  // ✅ CRITICAL: Pass season to useSchedule
  const {
  ...
  }, [selectedConference, startMeasurement, trackEvent, hasInitialized, season]);
  ...
  }, [scheduleError, selectedConference, trackEvent, season]);
                        ...
                        <div className="flex flex-row items-start gap-4">
                          ...
                          >
                            <TableActionButtons
                              ...
                              pathname={`/basketball/${season}/schedule`}
                            />
                          </div>
                        </div>
                      </div>
