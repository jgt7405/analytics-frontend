...
interface ArchiveBasketballTeamPageProps {
  params: {
    season: string;
    teamname: string;
  };
...
export default function ArchiveBasketballTeamPage({
  params,
}: ArchiveBasketballTeamPageProps) {
  ...
  useEffect(() => {
    trackEvent({
      name: "page_view",
      properties: {
        page: "basketball-team",
        team: teamname,
        mode: "archive",
        season,
      },
    });
  }, [teamname, trackEvent, season]);
  ...
  const navigateToTeam = (targetTeam: string) => {
    if (targetTeam && targetTeam !== teamname) {
      router.push(
        `/basketball/${season}/team/${encodeURIComponent(targetTeam)}`,
      );
    }
  };
        ...
        <div className="space-y-3">
          {isMobile ? (
            ...
            <div className="space-y-2">
              ...
              {/* Mobile History Components - Archive Mode - Season Filtered */}
              <div
