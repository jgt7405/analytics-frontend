...
export default function ArchiveBasketballConfDataPage({
  ...
  const {
    ...
    error: confError,
    refetch,
  } = useBasketballConfData(season);

  // ✅ CRITICAL: Pass season to useBasketballConfDataHistory
  const {
    data: historyData,
    isLoading: historyLoading,
    error: historyError,
  } = useBasketballConfDataHistory(season);
                  ...
                  <div className="flex flex-row items-start gap-4">
                    ...
                    >
                      <TableActionButtons
                        ...
                        pathname={`/basketball/${season}/conf-data`}
                      />
                    </div>
                  </div>
                </div>
