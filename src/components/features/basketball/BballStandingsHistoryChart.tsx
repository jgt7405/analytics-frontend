...
// modernized Wins/Standings/CWV/etc. pages. Same pattern as
// FootballStandingsHistoryChart.tsx (the §8 reference implementation).
...
export default function BballStandingsHistoryChart({
  ...
  useEffect(() => {
    return () => {
      document.getElementById("chartjs-tooltip-bball-standings")?.remove();
    };
  }, []);
      ...
      tooltip: {
        ...
        external: (args: { chart: Chart; tooltip: TooltipModel<"line"> }) => {
          ...
          renderExternalTooltip(chart, tooltipModel, {
            id: "chartjs-tooltip-bball-standings",
            isDark,
            heading,
            rows,
            verticalOffset: 0,
