...
export default function BballScatterplotChart() {
  ...
  return (
    <div className={cn(layout.card, "p-6")}>
      <h2 className="text-xl font-semibold mb-4">Scatterplot Chart</h2>
            ...
            >
              ...
              {positionedLogos.map((team) => (
                ...
                >
                  ...
                  {team.logo_url && (
                    <image
                      x={team.adjustedX - settings.logoSize / 2}
                      y={team.adjustedY - settings.logoSize / 2}
